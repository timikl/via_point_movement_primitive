function [RBF]=RBF_Train(y, RBF, nu)
...
for t=1:NT
    ...
    x = exp(-RBF.a_x*t*RBF.dt/RBF.tau);
    %faza z integracijo je manj natan?na !!!
    %vsaj pri u?enju je ni treba ra?unati z integracijo !!!
    %dx = -RBF.a_x*x/RBF.tau*nu(t);
    %x = x + dx*RBF.dt;
    %fprintf(' t = %d  x = %f  nu = %f\n',t,x,nu(t))    
end 
AI =  pinv(A);
RBF.w = AI*y;
