...
x_via = 1.5;
y_via = -1.9;
%Za to rabim x in y, x je faza, odvisna od Ä?asa (x-os)
S.x = exp(-RBF.a_x*x_via/RBF.tau);
%sigma_y je sigma(x_via) manjÅ¡i sigma, bolj sili v via toÄ?ko - to je design
%parameter in ga ni treba raÄ?unati
